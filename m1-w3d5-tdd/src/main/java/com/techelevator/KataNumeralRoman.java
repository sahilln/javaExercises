//I couldn't figure this one out on my own but was able to use the internet to find a good solution. 
//Testing is my own work though.
package com.techelevator;
import java.util.Scanner;

public class KataNumeralRoman {
